...
INSTANCE_ID="bd196209-51df-11f1-9f75-eeee0a95ee43"
...
curl -s -X GET "https://spa-api-gateway-bpi-ap-prod.cfapps.ap21.hana.ondemand.com/workflow/rest/v1/workflow-instances/$INSTANCE_ID" \
